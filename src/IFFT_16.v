...
(
    ...
    output reg signed [N-1:0] output_bank_parallel_r [F-1:0],
    output reg signed [N-1:0] output_bank_parallel_c [F-1:0],
    ...
    // conjugated wires
    wire signed [N-1:0] raw_stage_3_c [F-1:0];
    ...
    always @(posedge clk) begin
        if(reset) begin
            ...
            input_bank_c[F-1] <= -X_c; // Conjugate the input
   ...
   //stage 1
    ...
    butterfly_trivial_unit #(.N(N)) B3_0 (
        ...
        .Y_c_top(raw_stage_3_c[0]),
        .Y_r_bottom(stage_3_output_r[8]),
        .Y_c_bottom(raw_stage_3_c[8])
    );

    butterfly_unit #(.N(N)) B3_1 (
        .clk(clk),
        .reset(reset),
        .W_r(32'h7641AF3C),
        .W_c(32'hCF043AB3),
        ...
        .Y_c_top(raw_stage_3_c[1]),
        .Y_r_bottom(stage_3_output_r[9]),
        .Y_c_bottom(raw_stage_3_c[9])
    );

    butterfly_unit #(.N(N)) B3_2 ( 
        .clk(clk),
        .reset(reset),
        .W_r(32'h5A82799A),
        .W_c(32'hA57D8666),
        ...
        .Y_c_top(raw_stage_3_c[2]),
        .Y_r_bottom(stage_3_output_r[10]),
        .Y_c_bottom(raw_stage_3_c[10])
    );

    butterfly_unit #(.N(N)) B3_3 ( 
        .clk(clk),
        .reset(reset),
        .W_r(32'h30FBC54D),
        .W_c(32'h89BE50C4),
        ...
        .Y_c_top(raw_stage_3_c[3]),
        .Y_r_bottom(stage_3_output_r[11]),
        .Y_c_bottom(raw_stage_3_c[11])
    );
    ...
    butterfly_trivial_unit #(.N(N)) B3_4 (
        ...
        .Y_c_top(raw_stage_3_c[4]),
        .Y_r_bottom(stage_3_output_r[12]),
        .Y_c_bottom(raw_stage_3_c[12])
    );

    butterfly_unit #(.N(N)) B3_5 ( 
        .clk(clk),
        .reset(reset),
        .W_r(32'hCF043AB3),
        .W_c(32'h89BE50C4),
        ...
        .Y_c_top(raw_stage_3_c[5]),
        .Y_r_bottom(stage_3_output_r[13]),
        .Y_c_bottom(raw_stage_3_c[13])
    );

    butterfly_unit #(.N(N)) B3_6 ( 
        .clk(clk),
        .reset(reset),
        .W_r(32'hA57D8666),
        .W_c(32'hA57D8666),
        ...
        .Y_c_top(raw_stage_3_c[6]),
        .Y_r_bottom(stage_3_output_r[14]),
        .Y_c_bottom(raw_stage_3_c[14])
    );

    butterfly_unit #(.N(N)) B3_7 ( 
        .clk(clk),
        .reset(reset),
        .W_r(32'h89BE50C4),
        .W_c(32'hCF043AB3),
        ...
        .Y_c_top(raw_stage_3_c[7]),
        .Y_r_bottom(stage_3_output_r[15]),
        .Y_c_bottom(raw_stage_3_c[15])
    );

    // conjugated debugs
    genvar g_out;
    generate
        for(g_out=0; g_out<F; g_out=g_out+1) begin : out_conjugation
            assign stage_3_output_c[g_out] = -raw_stage_3_c[g_out];
        end
    endgenerate
